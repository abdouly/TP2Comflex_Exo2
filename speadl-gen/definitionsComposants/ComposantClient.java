...
public abstract class ComposantClient {
  ...
  public static class ComponentImpl implements ComposantClient.Component, ComposantClient.Parts {
    ...
    protected void init_unClient() {
      assert this.unClient == null: "This is a bug.";
      this.unClient = this.implementation.make_unClient();
      if (this.unClient == null) {
      	throw new RuntimeException("make_unClient() in definitionsComposants.ComposantClient shall not return null.");
      }
    }
   ...
   * 
   */
  protected abstract Runnable make_unClient();
